...
func TestInvalidValue(t *testing.T) {
	...
	// arrange
	type token1 struct {
		envString string `env:"ENV_STRING, default=test"` //nolint:unused
	}
	type token2 struct {
		envInt int `env:"ENV_INT, default=22"` //nolint:unused
	}
	type token3 struct {
		envBool bool `env:"ENV_BOOL, default=true"` //nolint:unused
	}
	type token4 struct {
		envFloat float32 `env:"ENV_FLOAT64, default=22.0"` //nolint:unused
	}
	type token5 struct {
		envStringSlice []string `env:"ENV_STRING_SLICE, default=[test,test]"` //nolint:unused
	}
	type token6 struct {
		envIntSlice []int `env:"ENV_INT_SLICE, default=[22]"` //nolint:unused
	}
	type token7 struct {
		envBoolSlice []bool `env:"ENV_BOOL_SLICE, default=[T]"` //nolint:unused
	}
	type token8 struct {
		envFloatSlice []float32 `env:"ENV_FLOAT64_SLICE, default=[22.0]"` //nolint:unused
	}
